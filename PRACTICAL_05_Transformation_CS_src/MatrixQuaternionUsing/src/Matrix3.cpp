...
/// </summary>
/// <param name="M">passed in matrix to multiply by</param>
/// <returns>the result of product of 2 matrices</returns>
Matrix3 Matrix3::operator*(const Matrix3 &M) const
{
	return Matrix3( Row(0) * M.Column(0), Row(0) * M.Column(1), Row(0) * M.Column(2),
					Row(1) * M.Column(0), Row(1) * M.Column(1), Row(1) * M.Column(2),
					Row(2) * M.Column(0), Row(2) * M.Column(1), Row(2) * M.Column(2));
}
/// <summary>
